# FindGUROBI.cmake — finds Gurobi headers and libraries and defines:
#   GUROBI_FOUND, GUROBI_INCLUDE_DIRS, GUROBI_LIBRARIES, GUROBI_LIBRARY, GUROBI_CXX_LIBRARY
# And imported targets:
#   Gurobi::gurobi, Gurobi::gurobi_cxx
#
# Usage:
#   find_package(GUROBI QUIET)         # or REQUIRED
#   if(GUROBI_FOUND)
#     target_link_libraries(your_tgt PRIVATE Gurobi::gurobi_cxx Gurobi::gurobi)
#   endif()
...
# Allow override via -DGUROBI_HOME=... or environment
set(_GUROBI_HOME_HINTS "")
if(DEFINED GUROBI_HOME)
  list(APPEND _GUROBI_HOME_HINTS "${GUROBI_HOME}")
elseif(DEFINED ENV{GUROBI_HOME})
  list(APPEND _GUROBI_HOME_HINTS "$ENV{GUROBI_HOME}")
endif()

# Common default locations (macOS and Linux)
file(GLOB _GUROBI_DEFAULT_HINTS
  "/Library/gurobi*/macos_universal2"
  "/opt/gurobi*/linux64"
  "/opt/gurobi*/linux64/src"
...
find_path(GUROBI_INCLUDE_DIR
  NAMES gurobi_c.h
  HINTS ${_GUROBI_HOME_HINTS} ${_GUROBI_DEFAULT_HINTS}
  PATH_SUFFIXES include
)

# Find core solver lib (versioned name first, then generic)
...
# On Unix/macOS, this is usually libgurobi_c++.a (static) or libgurobi_c++.dylib/.so
find_library(GUROBI_CXX_LIBRARY
  NAMES gurobi_c++ gurobi_c++md2019 gurobi_c++md2017
  HINTS ${_GUROBI_HOME_HINTS} ${_GUROBI_DEFAULT_HINTS}
  PATH_SUFFIXES lib
)
...
if(GUROBI_FOUND)
  ...
  if(NOT TARGET Gurobi::gurobi_cxx)
    ...
    # Link core lib transitively when using the C++ wrapper
